        ...
        <div className="md:flex md:space-x-10 space-y-5">
          <div className="w-full md:w-1/2">
            ...
            <p className="text-justify my-2">
              ...
              quality and value from your products and services and your company
              itself. Your manufacturing company's About Us page is the right
              place to share this important information.
            </p>
            <p className="text-justify my-2">
              ...
              all ISO promotional rules when publicizing your ISO
              certifications. There are specific ways a business must refer to
              their ISO certifications and how you represent them.
            </p>
            <p className="text-justify my-2">
